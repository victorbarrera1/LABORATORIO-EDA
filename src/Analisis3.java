...
/**
 * Análisis empírico del método cuentaPares3 (doble loop, fuerza bruta).
...
public class Analisis3 {
    ...
    public static void main(String[] args) {
        ...
        for (int t : exponentes) {
            ...
            String nombreArchivo = "resultados_metodo3_n" + n + ".csv";
            Out archivo = new Out(nombreArchivo);

            archivo.println("instancia,resultado,tiempo_ms");

            System.out.println("Método 3 | n=" + n + " | seed=" + t);
            ...
            for (int i = 0; i < INSTANCIAS; i++) {
                ...
                int resultado = Result.cuentaPares3(n, new ArrayList<>(valores), k);
        ...
        System.out.println("\nListo. Se generaron 6 archivos CSV para el método 3.");
    }
}
